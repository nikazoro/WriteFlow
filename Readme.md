...
WriteFlow is a secure and user-friendly personal journaling app built with the MERN stack (MongoDB, Express, React, and Node.js). It allows users to easily log in, write, view, and manage their daily entries while ensuring a seamless, distraction-free, and private experience. Prioritizing simplicity, security, and privacy, WriteFlow helps you document your thoughts and memories with confidence and peace of mind.

[Live Demo](https://zoro-writeflow.vercel.app)
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/nikazoro/WriteFlow.git
...
3. **Configure Environment Variables:**
   ...
   ```env
   PORT=3000
   MONGO_URI=mongodb://localhost:27017/writeflow
